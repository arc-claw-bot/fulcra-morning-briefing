...
2. Authorize: `fulcra-api auth login` (one-time, the user approves). For remote chat agents, send only the printed device URL and code to the intended user; never send access tokens or credential files.
